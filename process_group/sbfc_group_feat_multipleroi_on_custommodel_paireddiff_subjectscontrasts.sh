...
if [ $NUM_SUBJ -gt 0 ]; then
	...
	. $GLOBAL_GLM_SCRIPT_DIR/create_1group_2sessions_paired_diff_subjectscontrasts_glm.sh $PROJ_DIR -nsubj $NUM_SUBJ -model $TEMPLATE_GLM_FSF -odp $OUTPUT_ROOT_DIR -rndname $rndname
...
echo "set fmri(mixed_yn) 3" >> $OUTPUT_DIR.fsf   # FIXED EFFECT ANALYSIS
