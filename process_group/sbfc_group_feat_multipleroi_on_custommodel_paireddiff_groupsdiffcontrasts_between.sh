...
if [ ! -z $GROUPSLASTSIDS ]; then
	...
	. $GLOBAL_GLM_SCRIPT_DIR/create_2group_2sessions_paired_diff_between_glm.sh $PROJ_DIR -groupslastids $GROUPSLASTSIDS -model $TEMPLATE_GLM_FSF -odp $OUTPUT_ROOT_DIR -rndname $rndname
