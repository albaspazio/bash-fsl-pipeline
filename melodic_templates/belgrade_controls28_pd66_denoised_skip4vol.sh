template_name=belgrade_controls28_pd66_denoised_skip4vol
...
then
	...
	TEMPLATE_MASK_FOLDER=/media/data/MRI/projects/CAB/fsl_belgrade_early_pd/group_analysis/melodic/dr/templ_$template_name/controls28_pd66_denoised_skip4vol/mask	
else
...
str_pruning_ic_id="0,2,4,5,6,7"
str_arr_IC_labels="L_FP,EXEC_SM,DMN,DORSAL,LAT_VIS,R_FP"
declare -a arr_IC_labels=(L_FP EXEC_SM DMN DORSAL LAT_VIS R_FP)
