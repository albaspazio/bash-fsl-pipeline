template_name=belgrade_controls35_dyt50_skip4vol
...
str_pruning_ic_id="2,3,4,7,11,13,14,19"
str_arr_IC_labels="AUDIO_VENTRAL,FRONTAL,B_FP,X,R_FP,SM,DMN,DORSAL"
declare -a arr_IC_labels=(AUDIO_VENTRAL FRONTAL B_FP X R_FP SM DMN DORSAL)
declare -a arr_pruning_ic_id=(2 3 4 7 11 13 14 19)
