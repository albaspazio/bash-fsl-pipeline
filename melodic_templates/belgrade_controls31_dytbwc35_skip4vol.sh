template_name=belgrade_controls31_dytbwc35_skip4vol
...
str_pruning_ic_id="0,1,2,11,23,26,31,33,34"
str_arr_IC_labels="FRONTAL,SM,L_FP,LAT_VIS,FRONTAL_CAUD,VIS,DMN,DORSAL,AUDIO_VENTRAL"
declare -a arr_IC_labels=(FRONTAL SM L_FP LAT_VIS FRONTAL_CAUD VIS DMN DORSAL AUDIO_VENTRAL)
declare -a arr_pruning_ic_id=(0 1 2 11 23 26 31 33 34)
