template_name=belgrade_dyt_other_controls21_skip4vol
...
str_pruning_ic_id="0,1,5,6,13,14,23,25,27"
str_arr_IC_labels="B_FP,LAT_VIS_DORSAL,V1,FRONTAL,SALIENCE,DMN,L_FP,SM,R_FP"
declare -a arr_IC_labels=(B_FP LAT_VIS_DORSAL V1 FRONTAL SALIENCE DMN L_FP SM R_FP)
declare -a arr_pruning_ic_id=(0 1 5 6 13 14 23 25 27)
